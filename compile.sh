...
#Compile unit tests
g++    -fpermissive  -O3  -s  -std=c++17 -DLINUX           -o "bin/judoboard_test"          -Wno-attributes -Wno-format -Wno-conversion-null -Wno-format-extra-args -Wno-unused-result -Wno-deprecated-declarations -Wno-trigraphs       -I"."   -I"src"   -I"external"  `pkg-config --cflags gtk+-3.0`   tests/account.cpp  tests/app.cpp  "tests/ajax.cpp"   tests/age_group.cpp tests/database.cpp  tests/dm4.cpp  tests/judoka.cpp  tests/club.cpp  tests/id.cpp  tests/mat.cpp  tests/md5.cpp  tests/remote_mat.cpp   tests/match.cpp  tests/timer.cpp  tests/tournament.cpp                                           "libjudoboard.a"    -ldl  -lpthread   "ZED/libZED.a"   `pkg-config --libs gtk+-3.0`   -lSDL2 -lSDL2_ttf   -lfreetype  -lGL  -lEGL -lpng  "dep/yaml-cpp/libyaml-cpp.a"    -lgtest   -lgtest_main
g++    -fpermissive -g        -std=c++17 -D_DEBUG -DLINUX  -o "bin/judoboard_test_debug"    -Wno-attributes -Wno-format                                                                                                                  -I"."   -I"src"   -I"external"  `pkg-config --cflags gtk+-3.0`   tests/account.cpp  tests/app.cpp  "tests/ajax.cpp"   tests/age_group.cpp tests/database.cpp  tests/dm4.cpp  tests/judoka.cpp  tests/club.cpp  tests/id.cpp  tests/mat.cpp  tests/md5.cpp  tests/remote_mat.cpp   tests/match.cpp  tests/timer.cpp  tests/tournament.cpp                                           "libjudoboardd.a"   -ldl  -lpthread   "ZED/libZEDd.a"  `pkg-config --libs gtk+-3.0`   -lSDL2 -lSDL2_ttf   -lfreetype  -lGL  -lEGL -lpng  "dep/yaml-cpp/libyaml-cpp.a"    -lgtest   -lgtest_main