var lang_en = {
    ...
    in_preparation:  [ "In Preparation", "In Vorbereitung" ],
    import:  [ "Import", "Importieren" ],
    important:  [ "Important", "Wichtige" ],
    ...
    loser_bracket:  [ "Loser Bracket", "Trostrunde" ],
    lot:   [ "Lot", "Los" ],
    lots:  [ "Lots", "Lose" ],
    ...
    match_added:  [ "Match added to tournament", unescape("Kampf zum Turnier hinzugef%FCgt") ],
    ...
    on_mat:   [ "matches on mat", "K&auml;mpfe auf Matte" ],
    ...
    semifinals:  [ "Semifinals", "Halbfinale" ],
    show:  [ "Show", "Anzeigen" ],
    ...
    skip_break:  [ "Skip Break", "Ruhepause auslassen" ],
    skip_break_confirm:  [ "Are you sure you want to skip the current break time for both fighters?", unescape("Soll die aktuelle Kampfpause f%FCr beide K%E4mpfer wirklich ausgelassen werden?") ],
    start:  [ "Start", "Starten" ],
    start_next_match:  [ "Start Next Match", "Kampf starten" ],
    stop_match:  [ "Stop Match", "Kampf stoppen" ],
    save:  [ "Save", "Speichern" ],
    ...
    winner_bracket:  [ "Winner Bracket", "Hauptrunde" ],
    year: ["Year", "Jahr" ],
